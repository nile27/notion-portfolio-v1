...
const icon = (file: string, className = "w-full h-full object-contain shrink-0") => (
  <Image
...
export const SKILL_LOGOS: Record<string, React.ReactNode> = {
  ...
  "Next.js": icon("nextjs-original.svg"),
  "Tailwind CSS": icon("tailwindcss-original.svg"),
  "Express.js": icon("express-original.svg"),
  "MongoDB": icon("mongodb-original.svg"),
  "Git": icon("git-original.svg"),
  "Figma": icon("figma-original.svg"),
  "Python": icon("python.svg"),
  ".NET": icon("dotnet.svg"),
  "React Query": icon("reactquery.svg"),
  "Redux": icon("redux.svg"),
  "Styled-Components": icon("styledcomponents.svg"),
  "Firebase": icon("firebase.svg"),
  "SQLite": icon("sqlite.svg"),
  "Zustand": icon("zustand.svg"),
  "Framer Motion": icon("framer.svg"),
  "Claude & Claude Code": (
    <svg className="w-full h-full shrink-0" viewBox="0 0 24 24" fill="currentColor">
  ...
  "Antigravity": icon("antigravity_img.webp"),
};
