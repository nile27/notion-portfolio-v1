...
웹 서비스부터 데스크톱 애플리케이션 개발까지 다양한 기술을 다뤄왔습니다. 화면 설계부터 서버/클라이언트 개발 및 배포까지 서비스의 라이프사이클 전반을 경험하며 역할 간의 흐름을 유기적으로 이해하려 노력했습니다.`,
  ...
  projects: [
    {
      title: "TeamUp - 비개발자도 기획자가 되는 사이드프로젝트 매칭 플랫폼",
      ...
      notionId: "3cf61be3ce85805abbbdde4b663062f6",
      image: "/logo/logo-horizontal-light.svg",
    ...
    bootcamps: [
      {
        ...
        program: "AI를 활용한 Node.js와 JavaScript 기반 웹 개발자 양성 (수료)",
